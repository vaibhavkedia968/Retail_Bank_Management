...
{
	public static String USER_NOT_FOUND = "The given User does not exists.";
	...
	public static String WITHDRAW_FAILED = "Failed to withdraw money.";
	public static String TRANSFER_FAILED = "Failed to transfer money.";
